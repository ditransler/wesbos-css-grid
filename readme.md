...
# Edu project for "CSS Grid" course by Wes Bos

Here I'll try out everything Wes Bos teaches in the course [https://CSSGrid.io](https://CSSGrid.io)

The source repo with examples for the course - [link](https://github.com/wesbos/css-grid)
